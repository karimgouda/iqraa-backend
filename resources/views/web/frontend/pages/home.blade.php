            ...
            <div class="row g-0 mx-lg-0">
                ...
                <div class="col-lg-6 about-text py-5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="p-lg-5 pe-lg-0">
                        ...
                        <a href="{{route('site.about')}}" class="btn btn-primary rounded-pill py-3 px-5">{{__('pages.Explore More')}}</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                @foreach($blogs as $key=>$blog)
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.{{++$key}}s">
                        <div class="service-item border h-100 p-5">
                            ...
                            <a class="btn" href="{{route('site.services')}}"><i class="fa fa-arrow-right text-white me-3"></i>Read More</a>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                @foreach($testimonials as $testimonial)
                    <div class="testimonial-item text-center" data-dot="<img class='img-fluid' src='{{public_storage($testimonial->image)}}' alt=''>">
                        <p class="fs-5">
